...
WORKDIR /home
COPY . .
RUN apt-get update -qyy && apt-get install libopenblas-dev git htop byobu doxygen libzmq-dev python3-dev libasound2-dev build-essential cmake curl wget tmux byobu htop -qyy -qyy
